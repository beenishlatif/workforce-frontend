    ...
    <div style={S.page}>
      ...
      <div style={S.statGrid}>
        {[
          ...
          },
          {
            ...
            label:"Productivity",
            val:  `${stats.avgPct || 0}%`,
            vc:   prodColor(stats.avgPct || 0),
            link: "/employee/activity",
          },
          {
            icon: <Camera size={17} />,
            bg:   "#8b5cf6",
            label:"Screenshots",
            val:  stats.todayScreenshots || 0,
            sub:  "today",
            link: "/employee/screenshots",
          },
          {
            icon: <CheckCircle size={17} />,
            bg:   "#f59e0b",
            label:"Tasks Pending",
            val:  stats.pendingTasks || 0,
            vc:   stats.pendingTasks > 0 ? "#fbbf24" : "#4ade80",
            link: "/employee/activity",
          },
        ].map((m, i) => (
          <div
          ...
          >
            <div style={{
              ...
              background: `${m.bg}18`, border: `1px solid ${m.bg}28`,
              display: "flex", alignItems: "center", justifyContent: "center",
              color: m.bg, marginBottom: 12,
            }}>
              {m.icon}
            </div>
      ...
      <div style={S.twoCol}>
        ...
        <div style={S.card}>
          ...
          {recentAct.length === 0 ? (
            <div style={S.empty}>
              <Activity size={18} style={{ display: "block", margin: "0 auto 6px" }} />
              No activity today
            </div>
          ) : recentAct.map((a, i) => (
            <div
              ...
              style={{
                ...S.listRow,
                borderBottom: i < recentAct.length - 1
            ...
            >
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: prodColor(a.pct || 0), flexShrink: 0 }}>
                {a.pct || 0}%
              </span>
            </div>
          ))}
        ...
        <div style={S.card}>
          <div style={S.cardHead}>
            ...
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)" }}>
              {stats.completedTasks || 0}/{stats.totalTasks || 0} done
            </span>
          </div>
          ...
          {stats.totalTasks > 0 && (
            <div style={{ height: 5, background: "#1f2937", borderRadius: 4, overflow: "hidden", marginBottom: 14 }}>
              <div style={{
                height: "100%", background: "#4ade80", borderRadius: 4, transition: "width .5s",
          ...
          {recentTask.length === 0 ? (
            ...
            <div
              ...
              style={{
                ...S.listRow,
                borderBottom: i < recentTask.length - 1
                  ? "1px solid rgba(255,255,255,0.04)"
                  : "none",
              }}
            >
              <div style={{
                ...
                background: PRIORITY_C[t.priority] || "#818cf8", flexShrink: 0,
              }} />
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={S.rowTitle}>{t.title}</div>
                {t.due_date && (
                  <div style={S.rowSub}>Due {new Date(t.due_date).toLocaleDateString()}</div>
                )}
              </div>
              <span style={{
                fontSize: 9, padding: "2px 8px", borderRadius: 20, fontWeight: 600, whiteSpace: "nowrap",
      ...
      {/* ══ 3-col: Screenshots + Work Hours + Profile ══════════ */}
      <div style={S.threeCol}>
        ...
        <div style={S.card}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(90px,1fr))", gap: 8 }}>
            {recentShot.length === 0 ? (
              <div style={{ ...S.empty, gridColumn: "span 2" }}>
                <Camera size={16} style={{ display: "block", margin: "0 auto 6px" }} />
                No screenshots today
              </div>
            ) : recentShot.map((s, i) => (
              <div key={i} style={{
                borderRadius: 8, overflow: "hidden", background: "#0d0d10", position: "relative",
        ...
        <div style={S.card}>
            ...
            {Array.from({ length: 10 }, (_, i) => {
              ...
              return (
                <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}>
                  <div style={{
                    width: "100%",
                    height: `${Math.max(pct, mins > 0 ? 8 : 2)}%`,
                    minHeight: mins > 0 ? 4 : 1,
                    background: mins > 0 ? "#818cf8" : "#1f2937",
          ...
          <div style={{
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: 18, fontWeight: 800, color: prodColor(stats.avgPct || 0) }}>
                {stats.avgPct || 0}%
              </div>
            </div>
          </div>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <span style={{
                ...
                whiteSpace: "nowrap", maxWidth: 130, textAlign: "right",
              }}>
                {r.val}
              </span>
            </div>
...
const S = {
  ...
  viewBtn:   { display: "flex", alignItems: "center", gap: 3, fontSize: 11, color: "rgba(255,255,255,0.3)", background: "none", border: "none", cursor: "pointer", fontFamily: "inherit", transition: "color .15s", padding: 0 },
...
const CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .view-btn:hover  { color: #818cf8 !important; }
